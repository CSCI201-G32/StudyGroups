...
export const Chat = () => {
  ...
  const handleSubmit = async () => {
    if (message.trim() !== '') {
      await channelRef.current.trigger('client-presence-chat', 'client-message', {
        message,
      });
      inputMessage('');
    }
