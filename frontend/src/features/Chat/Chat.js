...
function Chat() {
    ...
    useEffect(() => {
        ...
        const pusher = new Pusher("f8627fe05e44c2e9db83", {cluster: 'us3'});
    ...
    // Get the username (first part of the email) of the user associated with the
    // current UserID
    useEffect(() => {
                    ...
                    <div className="messages-content">
                        {messages.map((message, index) => (
                            <div key={index} className="message-item">
                                <strong className="username">{message.username}:
                                </strong>
